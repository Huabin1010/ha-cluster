...
function AuthLoading() {
  return (
    <div className="grid min-h-svh place-items-center bg-background p-4">
      <Elevated offset={1} shadowLevel={2} className="rounded-2xl border border-border/80 bg-surface-1 px-6 py-4 shadow-surface-2">
        <Loading label="校验登录态…" />
      </Elevated>
    </div>
  );
    ...
    >
      <Routes>
        ...
        >
          ...
          <Route path="/projects/:id/workspaces" element={<ProjectDetailPage />} />
          ...
          <Route path="/workspaces/:id/overview" element={<MachinePage />} />
