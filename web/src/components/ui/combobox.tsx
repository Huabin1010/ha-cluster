...
>(props: ComboboxProps<T, Multiple>) {
  ...
  (highlightRef as any).current = safeHighlight;
  ...
  (onCreateRef as any).current = onCreate;
  ...
  ({ className, children, side = "bottom", align = "start", sideOffset = 6 }, ref) => {
    ...
    return (
      <PopoverPrimitive.Portal forceMount>
        ...
        >
          <motion.div
            className={cn(popupLayerClass, "outline-none", popupMotionClass)}
