...
const buttonVariants = cva(
  [
    "group relative isolate inline-flex items-center justify-center outline-none cursor-pointer whitespace-nowrap select-none shrink-0",
  ...
  ],
  {
    variants: {
      variant: {
        primary: "text-white dark:text-zinc-950 font-semibold",
        ...
        default: "text-white dark:text-zinc-950 font-semibold",
      },
...
const bgVariants: Record<string, string> = {
  primary:
    "[--btn-bg:var(--foreground,#12202e)] dark:[--btn-bg:var(--foreground,#ffffff)] group-hover:[--btn-bg:color-mix(in_oklab,var(--foreground,#12202e)_90%,var(--background,#ffffff))] dark:group-hover:[--btn-bg:color-mix(in_oklab,var(--foreground,#ffffff)_90%,var(--background,#0f1419))] group-active:[--btn-bg:color-mix(in_oklab,var(--foreground,#12202e)_80%,var(--background,#ffffff))] dark:group-active:[--btn-bg:color-mix(in_oklab,var(--foreground,#ffffff)_80%,var(--background,#0f1419))] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  secondary:
    "[--btn-bg:var(--accent,#2b7bb8)] group-hover:[--btn-bg:color-mix(in_oklab,var(--accent,#2b7bb8)_80%,var(--background,#ffffff))] group-active:[--btn-bg:var(--accent,#2b7bb8)] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  tertiary:
    "bg-transparent shadow-[0_0_0_1px_var(--border,#d7dee7),inset_0_0_0_0px_var(--border,#d7dee7)] dark:shadow-[0_0_0_1px_var(--border,#2a3542),inset_0_0_0_0px_var(--border,#2a3542)] group-hover:bg-hover group-active:bg-active group-active:shadow-[0_0_0_0px_var(--border),inset_0_0_0_1px_var(--border)]",
  ghost:
  ...
  outline:
    "bg-transparent shadow-[0_0_0_1px_var(--border,#d7dee7),inset_0_0_0_0px_var(--border,#d7dee7)] dark:shadow-[0_0_0_1px_var(--border,#2a3542),inset_0_0_0_0px_var(--border,#2a3542)] group-hover:bg-hover group-active:bg-active group-active:shadow-[0_0_0_0px_var(--border),inset_0_0_0_1px_var(--border)]",
  destructive:
    "[--btn-bg:var(--danger,#d64550)] group-hover:[--btn-bg:color-mix(in_oklab,var(--danger,#d64550)_90%,var(--background,#ffffff))] group-active:[--btn-bg:color-mix(in_oklab,var(--danger,#d64550)_80%,var(--background,#ffffff))] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  link:
...
const activeBgVariants: Record<string, string> = {
  primary:
    "[--btn-bg:color-mix(in_oklab,var(--foreground,#12202e)_80%,var(--background,#ffffff))] dark:[--btn-bg:color-mix(in_oklab,var(--foreground,#ffffff)_80%,var(--background,#0f1419))] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  secondary:
    "[--btn-bg:var(--accent,#2b7bb8)] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  tertiary:
    "bg-active shadow-[0_0_0_1px_var(--border,#d7dee7),inset_0_0_0_0px_var(--border,#d7dee7)] group-active:shadow-[0_0_0_0px_var(--border),inset_0_0_0_1px_var(--border)]",
  ghost:
    "bg-active shadow-[0_0_0_1px_var(--active)] group-active:shadow-[0_0_0_0px_var(--active)]",
  outline:
    "bg-active shadow-[0_0_0_1px_var(--border,#d7dee7),inset_0_0_0_0px_var(--border,#d7dee7)] group-active:shadow-[0_0_0_0px_var(--border),inset_0_0_0_1px_var(--border)]",
  destructive:
    "[--btn-bg:color-mix(in_oklab,var(--danger,#d64550)_80%,var(--background,#ffffff))] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  link:
    "bg-transparent shadow-none",
  default:
    "[--btn-bg:color-mix(in_oklab,var(--foreground,#12202e)_80%,var(--background,#ffffff))] dark:[--btn-bg:color-mix(in_oklab,var(--foreground,#ffffff)_80%,var(--background,#0f1419))] bg-[var(--btn-bg)] shadow-[0_0_0_1px_var(--btn-bg)] group-active:shadow-[0_0_0_0px_var(--btn-bg)]",
  ...
  (
    ...
    const internals = (
      <>
        ...
        />
        <span className="relative inline-flex items-center justify-center gap-[inherit] whitespace-nowrap">
          {loading ? (
            <>
              <span className="inline-flex items-center justify-center gap-[inherit] opacity-0 whitespace-nowrap">
                {LeadingIcon && !isIconOnly && (
                  <LeadingIcon size={iconSize} strokeWidth={2} className="shrink-0" />
                )}
                {label}
                {TrailingIcon && !isIconOnly && (
                  <TrailingIcon size={iconSize} strokeWidth={2} className="shrink-0" />
                )}
              </span>
            ...
            <>
              {LeadingIcon && (
                <LeadingIcon
                  size={iconSize}
                  strokeWidth={1.5}
                  className="shrink-0 transition-[stroke-width] duration-80 group-hover:stroke-[2]"
                />
              )}
              ...
              <span className="inline-flex items-center justify-center gap-[inherit] whitespace-nowrap [text-box:trim-both_cap_alphabetic]">{label}</span>
              {TrailingIcon && (
                <TrailingIcon
                  size={iconSize}
                  strokeWidth={1.5}
